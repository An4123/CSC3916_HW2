...
module.exports = function () {
    return {
         ...
         */
        save: function (user) {
            // creates a random user id and pushes (user, user.id) into userList[]
         ...
         */
        find: function (id) {
            // finds the first object with the same id 
            if (id) {
        ...
        findOne: function (name) {
            // finding user by name by looking in userList[]
            if (name) {
                return this.userList.find(function (element) {
        ...
        update: function (id, user) {
            // find the user in the list, and update username and password.
